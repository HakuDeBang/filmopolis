<form class="flex flex-row mb-4 justify-end">
    ...
    <div class="relative mr-4">
        ...
        <input type="text" id="table-search-users" class="block p-2 pl-10 md:text-md text-antiflashWhite border border-cardinal rounded-lg w-auto bg-spaceCadet focus:ring-cardinal focus:border-cardinal" placeholder="Rechercher un film">
    </div>
    ...
    <?php include('add_film_modal.php'); ?>
</form>
<div class="relative overflow-x-auto shadow-md rounded-lg">
    <table class="w-full text-sm text-center text-antiflashWhite">
        ...
        <tbody>
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <td class="w-52 p-4">
                    <img src="../../../FILMOPOLIS/assets/img/films/alice_darling/affiche_film.jpg" alt="Alice Darling">
                </td>
                <td class="px-6 py-4">
                    1h29min
                </td>
                <td class="px-6 py-4 font-normal text-antiflashWhite w-80">
    ...
    <?php include('edit_film_modal.php'); ?>
</div>

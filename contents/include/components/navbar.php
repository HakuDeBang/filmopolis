    ...
    <nav class="p-3 bg-spaceCadet">
        <div class="container flex flex-wrap items-center justify-between mx-auto">
            <a href="../../../filmopolis/index.php" class="flex flex-col items-center">
                <img src="../../../filmopolis/assets/img/pics/filmopolis.png" class="h-7 lg:h-10" alt="Filmopolis Logo"/>
                <h1 class="hidden lg:flex bg-cardinal rounded font-bold text-lg uppercase">Filmopolis</h1>
            </a>
            <div class="flex items-center lg:order-2">
                ...
                echo '<button type="button" class="flex mr-3 text-sm bg-gray-800 rounded-full md:mr-2" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="user-dropdown" data-dropdown-placement="bottom"><span class="sr-only">Open user menu</span>
                        <img class="w-8 h-8 lg:w-12 lg:h-12 rounded-full" src="../../../filmopolis/assets/img/pics/user.png" alt="user photo">
                    </button>';
                }else{
                    ...
                    <ul class="py-2" aria-labelledby="user-menu-button">
                        <li>
                            <?php if(isset($_SESSION['admin'])){
                                echo '<a href="../../../filmopolis/contents/pages/dashboard.php" class="flex flex-wrap items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white"><img src="../../../filmopolis/assets/img/pics/dashboard.png" class="mr-1 w-5" alt="">Tableau de bord</a>';
                            }
                            ?>
                        </li>
                        <li>
                            <a href="#" class="flex flex-wrap items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white"><img src="../../../filmopolis/assets/img/pics/settings.png" class="mr-1 w-5" alt="">Paramètres</a>
                        </li>
                        <li>
                            <a href="../../../filmopolis/contents/config/logout.php" class="flex flex-wrap items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white"><img src="../../../filmopolis/assets/img/pics/logout.png" class="mr-1 w-5" alt="">Se déconnecter</a>
                        </li>
                    </ul>
                </div>
                <!-- HAMBURGER MENU -->
            ...
            <div class="items-center justify-between hidden w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
                <ul class="flex flex-col p-4 mt-4 rounded-lg lg:flex-row lg:space-x-2 lg:mt-0 lg:text-sm lg:font-medium z-30">
                    <!-- DROPDOWN MENU GENRE -->
                    <li>
                    ...
                    <button type="button" class="w-full lg:py-0 lg:pl-0 lg:pr-0 lg:w-28 py-2 pl-3 pr-4 my-1 font-medium text-antiflashWhite rounded-lg bg-cardinal">
                        <a href="../../../filmopolis/contents/pages/catalogue.php" class="flex flex-wrap items-center justify-center"><img src="../../../filmopolis/assets/img/pics/catalogue.png" class="w-5 h-5 text-gray-500 dark:text-gray-400 mr-1" alt="">Catalogue</a>
                    </button>
                </ul>
            </div>
        </div>

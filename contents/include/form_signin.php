<div class="lg:grid lg:grid-flow-col lg:gap-2 xl:gap-4 h-full">
    ...
    <div class="lg:mr-10 py-3 w-full lg:mt-0 h-screen lg:h-full flex flex-col items-center justify-center bg-[url('../../../FILMOPOLIS/assets/img/films/alice_darling/gallery/5.jpg')] bg-cover lg:bg-none">
        ...
        <form class="border border-2 border-cardinal rounded-xl flex flex-col justify-center px-3 py-3 mt-2.5 backdrop-blur-sm" action="../../../FILMOPOLIS/contents/config/trait_signin.php" method="post">
            <div class="flex flex-row space-x-3 flex flex-row space-x-3">
                <div class="mb-3">
                    <input type="text" id="nom" class="bg-antiflashWhite border border-2 border-cardinal text-spaceCadet text-sm rounded-lg block w-full p-2.5" placeholder="Nom" name="nom_users">
                </div>
                <div class="mb-3">
                    <input type="text" id="prenom" class="bg-antiflashWhite border border-2 border-cardinal text-spaceCadet text-sm rounded-lg block w-full p-2.5" placeholder="Prenom" name="prenom_users">
                </div>
            </div>
            <div class="flex flex-row space-x-3 flex flex-row space-x-3">
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <input type="email" id="email" class="bg-antiflashWhite border border-2 border-cardinal text-spaceCadet text-sm rounded-lg block w-full p-2.5" placeholder="Adresse email" name="email_users">
                </div>
            </div>
            <div class="flex flex-row space-x-3 flex flex-row space-x-3">
                <div class="mb-3">

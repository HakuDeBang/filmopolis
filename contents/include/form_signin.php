    ...
    <div class="lg:mr-10 py-3 w-full lg:mt-0 h-full flex flex-col items-center justify-center bg-[url('../../../FILMOPOLIS/assets/img/films/alice_darling/gallery/5.jpg')] bg-cover lg:bg-none">
        ...
        <form class="border border-2 border-cardinal rounded-xl flex flex-col justify-center px-3 py-3 mt-2.5 backdrop-blur-sm">
            ...
            <div class="xl:flex xl:flex-row xl:space-x-3">
                ...
                <div class="mb-3">
                    <input type="email" id="confEmail" class="bg-antiflashWhite border border-2 border-cardinal text-spaceCadet text-sm rounded-lg block w-full p-2.5" placeholder="Confirmez votre adresse email" name="conf_email" required>
                </div>
            </div>
            <div class="xl:flex xl:flex-row xl:space-x-3">
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <input type="password" id="confMotdepasse" class="bg-antiflashWhite border border-2 border-cardinal text-spaceCadet text-sm rounded-lg block w-full p-2.5" placeholder="Confirmez votre mot de passe" name="conf_password" required></input>
                </div>
            </div>

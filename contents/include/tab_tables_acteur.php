<form class="flex flex-row mb-4 justify-end">
    ...
    <a href="#" type="button" class="text-antiflashWhite bg-eerieBlack border border-antiflashWhite font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center" data-modal-target="addActeurModal" data-modal-show="addActeurModal">Ajouter un acteur</a>
    <?php include 'add_acteurs_modal.php'; ?>
</form>
    ...
    <table class="w-full text-sm text-center text-antiflashWhite">
        ...
        <tbody>
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <td class="w-52 p-4">
                    <img src="../../../FILMOPOLIS/assets/img/acteurs/anna_kendrick.jpg" alt="Anna Kendrick">
                </td>

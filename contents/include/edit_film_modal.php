<!-- Edit Film Modal -->
<div id="editFilmModal" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 items-center justify-center hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] md:h-full">
    <div class="relative w-full h-full max-w-2xl md:h-auto rounded-lg shadow dark:bg-gray-700">
        ...
        <form action="#" method="post">
            ...
            <div class="p-6 space-y-6">
                <div class="grid grid-cols-6 gap-6">
                    <div class="col-span-6 sm:col-span-3">
                        ...
                        <input type="text" name="first-name" id="first-name" class="shadow-sm bg-spaceCadet border border-antiflashWhite text-antiflashWhite text-sm rounded-lg focus:ring-cardinal focus:border-cardinal block w-full p-2.5" placeholder="Alice, darling" required="">
                    </div>
                    <div class="col-span-6 sm:col-span-3">
                    ...
                    <div class="col-span-6 sm:col-span-3">
                        ...
                        <input type="text" name="duree" id="duree" class="shadow-sm bg-spaceCadet border border-antiflashWhite text-antiflashWhite text-sm rounded-lg focus:ring-cardinal focus:border-cardinal block w-full p-2.5" placeholder="1h29min" required="">
                    </div>
                    <div class="col-span-6 sm:col-span-3">
                        <label for="synopsis" class="block mb-2 text-sm font-medium text-antiflashWhite">Synopsis</label>
                        <input type="text" name="synopsis" id="synopsis" class="shadow-sm bg-spaceCadet border border-antiflashWhite text-antiflashWhite text-sm rounded-lg focus:ring-cardinal focus:border-cardinal block w-full p-2.5" placeholder="Lorem ipsum, dolor sit amet consectetur..." required="">
                    </div>
                    <div class="col-span-6 sm:col-span-3">
            ...
            <div class="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
                <button type="submit" class="text-spaceCadet bg-antiflashWhite border border-4 border-spaceCadet hover:text-antiflashWhite hover:bg-spaceCadet hover:border-antiflashWhite font-medium rounded-lg text-sm px-5 py-2.5 text-center">Éditer</button>
            </div>
        </form>
    </div>
</div>